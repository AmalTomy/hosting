...
urlpatterns = [
    ...
    # path('get_destinations/', views2.get_destinations, name='get_destinations'),
    ...
    #views4
    path('policehome/',views4.policehome, name='policehome'),
    path('',views4.eg3, name='eg3'),    
    path('aboutus/',views4.aboutus, name='aboutus'),
    path('userhome/',views4.userhome, name='userhome'),
    path('reportpolice/',views4.reportpolice, name='reportpolice'),
    path('reportuser/',views4.reportuser, name='report_user'),
    path('surveillance/', views4.surveillance, name='surveillance'),
    path('surveillance2/', views4.surveillance2, name='surveillance2'),
    path('alert/',views4.alert, name='alert'),
    path('addpolice/',views4.addpolice, name='addpolice'),
    path('viewpolice/',views4.viewpolice, name='viewpolice'),
    path('viewuser/',views4.viewuser, name='viewuser'),
    path('deletepolice/',views4.deletepolice, name='deletepolice'),
    path('editpolice/',views4.editpolice, name='editpolice'),
    path('edituser/',views4.edituser, name='edituser'),
    path('detect/',views4.detect, name='detect'),
    path('missing/',views4.missing, name='missing'),
    path('missing2/',views4.missing2, name='missing2'),
    path('missing3/',views4.missing3, name='missing3'),
    path('deleteuser/',views4.deleteuser, name='deleteuser'),
    path('deleteperson/',views4.deleteperson, name='deleteperson'),
    path('editperson/',views4.editperson, name='editperson'),
    path('viewcase/',views4.viewcase, name='viewcase'),
    path('viewcase2/',views4.viewcase2, name='viewcase2'),
    path('investigatingcase/',views4.investigatingcase, name='investigatingcase'),
    path('transfercase/',views4.transfercase, name='transfercase'),
    path('discard/',views4.discard, name='discard'),
    path('finish/',views4.finish, name='finish'),
    path('logout/',views4.logout, name='logout'),
    path('test_whatsapp/', views4.test_whatsapp, name='test_whatsapp'),   
    
    
    #views5
    path('packages/', views5.package, name= 'packages'),    
    path('mod_addpackage/', views5.mod_addpackage, name= 'mod_addpackage'),
    path('package_details/<int:package_id>/', views5.package_details, name='package_details'),
    path('get_destinations/', views5.get_destinations, name='get_destinations'),
    path('mod_viewaddedpackages/', views5.mod_viewaddedpackages, name='mod_viewaddedpackages'),
    path('disable-package/<int:package_id>/', views5.disable_package, name='disable_package'),
    path('your_activity/', views5.your_activity, name='your_activity'),
    path('generate_activity_report/', views5.generate_activity_report, name='generate_activity_report'),
    path('mod_your_activities/', views5.mod_your_activities, name='mod_your_activities'),
    path('generate_mod_activity_report/', views5.generate_mod_activity_report, name='generate_mod_activity_report'),
    path('generate_agent_report/', views5.generate_agent_report, name='generate_agent_report'),
    path('admin_report_gen/', views5.admin_report_gen, name='admin_report_gen'),
    path('generate_admin_report/', views5.generate_admin_report, name='generate_admin_report'),
    path('preview_admin_report/', views5.preview_admin_report, name='preview_admin_report'),
    path('get_routes/', views5.get_routes, name='get_routes'),
